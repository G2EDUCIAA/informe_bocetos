...
La primera vez que se compila el proyecto, es necesario hacer un \textit{Clean Project}. Esto ejecutará el comando \textit{Clean$_$generate} del make, creando todos los archivos necesarios para la compilación con el RTOS.
