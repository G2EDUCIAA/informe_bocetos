...
En la Figura  \ref{diagramaenbloques} puede observarse el diagrama en bloques de la placa, puede notarse que la placa cuenta con 2 puertos micro-USB (uno para aplicaciones y debugging, otro para alimentación); 4 salidas digitales implementadas con leds RGB, 4 entradas digitales con pulsadores; 1 puerto de comunicaciones RS485 con bornera. La Figura  \ref{distribucionpines} ilustra el distribución de los pines sobre cada puerto.
 \\
...
\begin{enumerate}
\item[•]Una vez realizada la descarga del instalador, se ejecuta dicha aplicación, la Figura \ref{Fig4} muestra el arranque del instalador, sobre ella, debe seleccionarse \textit{Siguiente}.
\begin{figure}[H]
\centering
...
\label{Fig4}
\end{figure}
\item[•]A continuación, el usuario debe aceptar las licencias para la utilización del programa. Como se muestra en La Figura \ref{Fig5}.
\begin{figure}[H]
\centering
...
\begin{enumerate}
\item[•]Ejecutar el programa \textit{uninstall.exe} ubicado en el directorio de instalación del programa.
\item[•]Luego se presenta la ventana de la Figura \ref{des1}. Hacer click en \textit{Siguiente}.
\begin{figure}[H]
\centering
...
\label{des1}
\end{figure}
\item[•]Seleccionar el directorio de instalación, en caso de haber instalado el programa en el directorio por defecto se tiene una ventana similar a la Figura \ref{des2}. Luego hacer click sobre \textit{Desinstalar}.
\begin{figure}[H]
\centering
...
\label{des2}
\end{figure}
\item[•]Finalmente se presenta una ventana como la Figura \ref{des3}. Sobre ella debe hacer click sobre \textit{Terminar}
\begin{figure}[H]
\centering
...
\item[•]Realizar la compilación y depuración del programa.
\end{enumerate}
