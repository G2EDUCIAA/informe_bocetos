...
En este ejemplo también se utiliza un display LCD 16x2. Para el manejo del mismo fue necesario utilizar una libreria, la cual fue diseñada por Matias Ferraro\cite{repositoriomatiasferraro}.
