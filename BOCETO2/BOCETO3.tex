...
El programa se encuentra disponible de forma gratuita en la dirección web. La instalación de dicho programa es simple, sin embargo, es necesario destacar que durante dicho proceso, el usuario debe obviar la instalación de los drivers que provee dicho programa.
 \\
...
\bibitem{origeneduciaa}\underline{Origen EDU CIAA}: Inclusión de Figuras \ref{Fig_placa}, \ref{Fig2}, \ref{diagramaenbloques}, \ref{Fig3}. 

Dirección Web:

http://proyecto-ciaa.com.ar/devwiki/doku.php?id=proyecto:origen$\_$ciaa
...
http://proyecto-ciaa.com.ar/devwiki/doku.php?id=desarrollo:firmware:instalacion$\_$sw$\&$s[]=puente
...
http://proyecto-ciaa.com.ar/devwiki/doku.php?id=docu:fw:bm:make$\&$s[]=makefile
...
\begin{footnotesize}
http://proyecto-ciaa.com.ar/devwiki/doku.php?id=docu:fw:bm:estructura$\&$s[]=estructura$\&$s[]=de$\&$s[]=directorios

\end{footnotesize}
Fecha: 15/10/16 11:00 am.
\bibitem{sapi}\underline{\textit{sAPI} Introducción versión 0.3.0}: Inclusión de Figuras \ref{distribucionpines}, \ref{Fig18}.
...
http://www.sase.com.ar/2011/files/2010/11/SASE2011-Introduccion$\_$RTOS.pdf

Fecha: 15/11/16 09:00 pm.
...
https://gitlab.com/pridolfi/rtos$\_$ii$\_$ejercicios/tree/master/gpioint

Fecha: 20/11/16 11:00 am.
\bibitem{octoplusterminal} \underline{Dirección descarga de \textit{Octoplus} Terminal}:

Dirección Web:

http://octoplus-terminal.software.informer.com/download/

Fecha: 10/11/16 09:00 pm.
\end{thebibliography}
