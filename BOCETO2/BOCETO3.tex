...
\bibitem{sapi}\underline{\textit{sAPI} versión 0.3.0:Introducción}:
...
\bibitem{enlacelibreriainterrupcion} \underline{Enlace web de repositorio de librería que implementa interrupción externa sobre GPIO0}:
